 ...
 * 
 */
@WebServiceClient(name = "HelloWorld", targetNamespace = "http://impl.server.jaxws.webservice.study.com/", wsdlLocation = "http://172.30.18.109:8080/services/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLD_QNAME = new QName("http://impl.server.jaxws.webservice.study.com/", "HelloWorld");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.30.18.109:8080/services/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.server.jaxws.webservice.study.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.server.jaxws.webservice.study.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
